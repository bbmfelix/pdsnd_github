...
if __name__ == "__main__":
  ...
  --------------------------------------------------------------------------------------------------------------------------------------------------------------------
  --------------------------------------------------------------------------------------------------------------------------------------------------------------------
# http://www.programmersought.com/article/2190315618/#___146
...
def display_data(df):
    ...
    display_active = input("Do you want to see the raw data? (Yes/No): ").lower()
    ...
    if display_active == 'yes':
        while end_loc <= df.shape[0] - 1:
            ...
            end_display = input("Do you wish to continue? (Yes/No): ").lower()
            if end_display == 'no':
                break
